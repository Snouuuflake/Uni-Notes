...
\begin{longtblr}{
  ...
  & {
    ...
    Forma general de una ecuación diferencial ordinaria de orden $n$: $f(x,y,y^',\dots,y^n) = 0$, donde $y^n = \frac{d^n y}{dx^n}$.
  }
  \\
  Grado
  ...
  & \begin{minipage}{\linewidth}
    Dado $f(x,y^',\dots,y^n) = 0$, $y = y(x, C_1, C_2,\dots,C_n)$.
    \medskip
